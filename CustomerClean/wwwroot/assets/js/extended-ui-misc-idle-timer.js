...
$(function () {
  ...
  if (timerDoc.length) {
    ...
    $(document).on('idle.idleTimer', function (event, elem, obj) {
      timerDoc
        .val(function (i, value) {
          return value + 'بیکار @ ' + moment().format() + ' \n';
        })
    ...
    $(document).on('active.idleTimer', function (event, elem, obj, e) {
      timerDoc
        .val(function (i, value) {
          return value + 'فعال [' + e.type + '] [' + e.target.nodeName + '] @ ' + moment().format() + ' \n';
        })
    ...
    btnPause.on('click', function () {
      ...
      timerDoc.val(function (i, value) {
        return value + 'مکث کرد @ ' + moment().format() + ' \n';
      });
      $(this).blur();
      return false;
    });
    btnResume.on('click', function () {
      ...
      timerDoc.val(function (i, value) {
        return value + 'ادامه داده شد @ ' + moment().format() + ' \n';
      });
      $(this).blur();
      return false;
    });
    ...
    btnDestroy.on('click', function () {
      ...
      timerDoc
        .val(function (i, value) {
          return value + 'از بین رفت: @ ' + moment().format() + ' \n';
        })
        .removeClass('alert-success')
        .removeClass('alert-warning');
      $(this).blur();
    ...
    btnInit.on('click', function () {
      ...
      timerDoc.val(function (i, value) {
        return value + 'راه‌اندازی: @ ' + moment().format() + ' \n';
      });
    ...
    if ($(document).idleTimer('isIdle')) {
      timerDoc
        .val(function (i, value) {
          return value + 'وضعیت بیکاری اولیه @ ' + moment().format() + ' \n';
        })
        .removeClass('alert-success')
        .addClass('alert-warning');
    } else {
  ...
  if (elementTimer.length) {
    ...
    elementTimer.on('active.idleTimer', function (event) {
      ...
      elementTimer
        .val(function (i, value) {
          return value + 'فعال @ ' + moment().format() + ' \n';
        })
        .addClass('alert-success')
        .removeClass('alert-warning');
    });
    ...
    btnReset.on('click', function () {
      ...
      elementTimer.idleTimer('reset').val(function (i, value) {
        return value + 'بازنشانی @ ' + moment().format() + ' \n';
      });
    ...
    if (elementTimer.idleTimer('isIdle')) {
      elementTimer
        .val(function (i, value) {
          return value + 'بیکاری اولیه @ ' + moment().format() + ' \n';
        })
        .removeClass('alert-success')
        .addClass('alert-warning');
    } else {
      elementTimer
        .val(function (i, value) {
          return value + 'فعالی اولیه @ ' + moment().format() + ' \n';
        })
        .addClass('alert-success')
        .removeClass('alert-warning');
    }
